using JSON
include("link_cut_MEW/lct_run_LA.jl")
...
seed1 = JSON.parsefile("LA/seed_plan1.json")
...
seed_1_ntd = [seed1_int_int[i - 1] + 1 for i in 1:length(nodes)] # +1 for 1-based indexing in Julia
